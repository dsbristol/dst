...
* [{{ site.data.block07.s01.text }}]({{ site.data.block07.s01.url }})
    * Portfolio Discussion: [{{ site.data.block07.s0101.text }}]({{ site.data.block07.s0101.url }})

* [{{ site.data.block07.s02.text }}]({{ site.data.block07.s02.url }})
    * Portfolio Discussion: [{{ site.data.block07.s0201.text }}]({{ site.data.block07.s0201.url }})
	
## Workshop:

* [{{ site.data.block07.s03.text }}]({{ site.data.block07.s03.url }})
...
* The main long form portfolio [Portfolio 7]({{ site.data.block07.portfolio.url }}).
* **Block07** on Noteable via [{{ site.data.blackboard.main.text }}]({{ site.data.blackboard.main.url }})
