...
* [01.2 EDA]({{ site.data.block01.s0102-Classification.url }})
  * [01.2.P Portfolio on Classification]({{ site.data.block01.s010201-PortfolioClassification.url }})
  * Second unexamined portfolio: [01.2.P2 Portfolio on Historical Classifiers]({{ site.data.block01.s010202-PortfolioNotesSecondTopic.url }})
...
* 1.3.3 Workshop Lecture on Assessments
  ...
  * Split into the following parts:
  ...
  - Previous DST Projects [Starred by the dsbristol github account](https://github.com/dsbristol?tab=stars)

## Assessments (Formative):

* Formative Portfolio, consisting:
  * The main long form portfolio [Formative Portfolio]({{ site.data.block01.portfolio.url }}).
  * **Noteable Worksheet** on via Blackboard -> Data Science Toolbox 2026 -> Noteable
  * **Block01** on Noteable via [{{ site.data.blackboard.main.text }}]({{ site.data.blackboard.main.url }})
...
* Group Assessment 0, consisting of [Assessment 0]({{ site.data.assessment0.url }}) (see [Assessments](../assessments.md))
