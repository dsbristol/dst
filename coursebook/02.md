...
* [02.1.P Portfolio on Information Criteria]({{ site.data.block01.s020101-AIC.url }})

### Cross Validation:

 [02.2 Cross Validation]({{ site.data.block02.s0201-CV.url }})
* [Reference R code]({{ site.data.block02.c02-Testing.url }})
* [02.2.P Portfolio on leave-one-out Cross Validation]({{ site.data.block01.s020201-CV.url }})
