...
---
# Workshop 6.3.1 Overview

This is Block 6 Workshop (which is 6.3) part 1. Part 2 is in Python.
...
The code is minimally updated from Block 5 and all interpretation is done within the Python content.
