...
* Formative Assessments (that do not contribute to grade):
  - [Assessment 0]({{ site.data.2025.assessment0.url }}) (Due Week 3)
  - [Portfolio 0]({{ site.data.2025.individualassessment0.url }}) (Due Week 3)
    - Including the short Questions for [Block 01](coursebook/01.md).
* Summative Group Assessments: total 60% (each 30%)
  - [Assessment 1: Supervised Prediction]({{ site.data.2025.assessment1.url }}) (First group assessment)
  - [Assessment 2: Data at Scale]({{ site.data.2025.assessment2.url }}) (Second group assessment)
* Individual Portfolios: total 40% 
  - (80%) [Individual Portfolio: Statistical Machine Learning]({{ site.data.2025.individualassessment1.url }})
...
* [Portfolio Block 02]( {{ site.data.2025.block02.portfolio.url }} )
* [Portfolio Block 03]( {{ site.data.2025.block03.portfolio.url }} )
* [Portfolio Block 04]( {{ site.data.2025.block04.portfolio.url }} )
* [Portfolio Block 05]( {{ site.data.2025.block05.portfolio.url }} )
* [Portfolio Block 06]( {{ site.data.2025.block06.portfolio.url }} )
* [Portfolio Block 07]( {{ site.data.2025.block07.portfolio.url }} )
* [Portfolio Block 08]( {{ site.data.2025.block08.portfolio.url }} )
* [Portfolio Block 09]( {{ site.data.2025.block09.portfolio.url }} )
* [Portfolio Block 10]( {{ site.data.2025.block10.portfolio.url }} )
* [Portfolio Block 11]( {{ site.data.2025.block11.portfolio.url }} )
...
* The [Equity Formula](/dst/cb-2025/assets/assessments/equityshare.nb.html) for redistributing marks.
