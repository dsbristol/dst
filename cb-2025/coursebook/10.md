...
*  [Introduction to Parallelism]({{ site.data.2025.block10.s01.url }})
*  [Vectorisation, Mapping and Reducing]({{ site.data.2025.block10.s02.url }})

## Workshop:

* [10.3 Workshop on Coding Parallel Algorithms]({{ site.data.2025.block10.s03.url }})

## Assessments:

* [Portfolio 10]({{ site.data.2025.block10.portfolio.url }}) of the full [Portfolio]({{ site.data.2025.individualassessment1.url }}).
