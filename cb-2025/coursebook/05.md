...
* [05.1 Introduction to Classification]({{ site.data.2025.block05.s01.url }})
  * [Reference R code]({{ site.data.2025.block05.c01.url }})
* [05.2 Ensemble learning]({{ site.data.2025.block05.s02.url }})

## Workshop:

* [5.3 Workshop on Ensemble Methods (.Rmd)]({{ site.data.2025.block05.s03.url }})
* [5.3 Workshop on Ensemble Methods (.html)]({{ site.data.2025.block05.s03-h.url }})

## Assessments:

* [Portfolio 05]({{ site.data.2025.block05.portfolio.url }}) of the full [Portfolio]({{ site.data.2025.individualassessment1.url }}).
...
* [Worksheet 5.1 Non-parametrics]({{ site.data.2025.block05.ws01.url }}) 
* [Worksheet 5.2 Outliers and Missing Data]({{ site.data.2025.block05.ws02.url }})
