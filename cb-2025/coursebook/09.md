...
* [09.1 Analysing Algorithms: Complexity, Algorithms and Turing Machines]({{ site.data.2025.block09.s01.url }})
* [09.2 Algorithms for Data Science]({{ site.data.2025.block09.s02.url }})

## Workshop:

* [09.3 Workshop on the Empirical evaluation of computational complexity]({{ site.data.2025.block09.s03.url }})
* **Block09** on Noteable via [Blackboard](https://www.ole.bris.ac.uk/ultra/courses/_255714_1/cl/outline):

## Assessment:

* [Portfolio 09]({{ site.data.2025.block09.portfolio.url }}) of the full [Portfolio]({{ site.data.2025.individualassessment1.url }}).
...
* [Worksheet 9.1 Algorithms]({{ site.data.2025.block09.ws01.url }}) 
