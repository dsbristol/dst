...
* [02.1-Modern Regression]({{ site.data.2025.block02.s0101-Regression.url }})
...
### Statistical Testing and Model Selection:
 ...
 [02.2-Statistical Testing]({{ site.data.2025.block02.s0201-Testing.url }})
...
* [02.3 Model Selection (.Rmd)]({{ site.data.2025.block02.s03-ModelSelection.url }})
* [02.3 Model Selection (.html)]({{ site.data.2025.block02.s03-ModelSelection-h.url }})

## Assessments:

* The full [Portfolio]({{ site.data.2025.individualassessment1.url }}) will be set in this week; see [Assessments](../assessments.md). This is a summative assessment (i.e. does contribute to your grade) and will be due in Week 12, but contains material to work on each week.
* [Portfolio 02]({{ site.data.2025.block02.portfolio.url }}) of the full [Portfolio]({{ site.data.2025.individualassessment1.url }}).
...
* [Worksheet 2.1 Regression and Correlation]({{ site.data.2025.block02.ws01.url }}) 
* [Worksheet 2.2 Statistical Testing]({{ site.data.2025.block02.ws02.url }})
