...
* [04.1 Non-parametric Statistics]({{ site.data.2025.block04.s01.url }})
  * [Reference R code]({{ site.data.2025.block04.c01.url }})
* Missing Data:
  * [04.2 Outliers and Missing data]({{ site.data.2025.block04.s02.url }})
  * [Reference R code]({{ site.data.2025.block04.c02.url }})
  
## Workshop:

* [04.3 Workshop on Missing Data (.Rmd)]({{ site.data.2025.block04.s03.url }})
* [04.3 Workshop on Missing Data (.html)]({{ site.data.2025.block04.s03-h.url }})

## Assessments:

* [Portfolio 04]({{ site.data.2025.block04.portfolio.url }}) of the full [Portfolio]({{ site.data.2025.individualassessment1.url }}).
...
* [Worksheet 4.1 Non-parametrics]({{ site.data.2025.block04.ws01.url }}) 
* [Worksheet 4.2 Outliers and Missing Data]({{ site.data.2025.block04.ws02.url }})
