...
* [03.1-Latent Structures and PCA]({{ site.data.2025.block03.s01-PCA.url }})
  * [Reference R code]({{ site.data.2025.block03.c01.url }})
* [03.2-Clustering]({{ site.data.2025.block03.s02-Clustering.url }})
  * [Reference R code]({{ site.data.2025.block03.c02.url }})

## Workshop:

* [03.3 PCA and Clustering (.Rmd)]({{ site.data.2025.block03.s03-SpectralEmbedding.url }})
* [03.3 PCA and Clustering (.html)]({{ site.data.2025.block03.s03-SpectralEmbedding-h.url }})

## Assessments:

* [Assessment 1]({{ site.data.2025.assessment1.url }}) will be set in this week; see [Assessments](../assessments.md). This is a summative assessment (i.e. does contribute to your grade) and will be due in Week 7.
* [Portfolio 03]({{ site.data.2025.block03.portfolio.url }}) of the full [Portfolio]({{ site.data.2025.individualassessment1.url }}).
...
* [Worksheet 3.1 Latent Spaces and PCA]({{ site.data.2025.block03.ws01.url }}) 
* [Worksheet 3.2 Clustering]({{ site.data.2025.block03.ws02.url }})
