...
* [01.1-Intro]({{ site.data.2025.block01.s0101-Intro.url }})
* [01.2-EDA]({{ site.data.2025.block01.s0102-EDA.url }})
...
* [{{ site.data.2025.vid01.v0302.text }}]({{ site.data.2025.vid01.v0302.url }}):
  ...
  * [HTML for 1.3.2 Exploratory Data Analysis R markdown]({{ site.data.2025.block01.s0103-EDA-h.url }}) 
...
* 1.3.3 Workshop Lecture on Assessments
  ...
  * Split into the following parts:
  ...
  - [{{ site.data.2025.vid01.v. 30305.text }}]({{ site.data.2025.vid01.v030305.url }}) ([Example Assessment link](https://github.com/dsbristol/dst_example_project))

## Assessments (Formative):

* Formative Portfolio, consisting:
  * [Portfolio 01]({{ site.data.2025.block01.portfolio.url }}) long form worksheet.
  * **Noteable Worksheet** on via [Blackboard](https://www.ole.bris.ac.uk/ultra/courses/_255714_1/cl/outline):
* **How to access Noteable**:
...
* Group Assessment 0, consisting of [Assessment 0]({{ site.data.2025.assessment0.url }}) (see [Assessments](../assessments.md))
...
* [Worksheet 1.2 Exploratory Data Analysis]({{ site.data.2025.block01.ws02.url }}) 
