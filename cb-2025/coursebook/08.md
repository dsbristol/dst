...
* [08.1 A Brief primer in Bayesian methods]({{ site.data.2025.block08.s01.url }})
* [08.2 Topic Models and Latent Dirichlet Allocation]({{ site.data.2025.block08.s02.url }})
...
* [Python Notebook: 8.3.1 Topic Models (Software and downloading data)]({{ site.data.2025.block08.s0301.url }})
* [Python Notebook: 8.3.2 Topic Models]({{ site.data.2025.block08.s0302.url }})

## Assessments:

* [Portfolio 08]({{ site.data.2025.block08.portfolio.url }}) of the full [Portfolio]({{ site.data.2025.individualassessment1.url }}).
* **Block08** on Noteable via [Blackboard](https://www.ole.bris.ac.uk/ultra/courses/_255714_1/cl/outline):

## References:

### Cutting edge
* [LangExtract](https://github.com/google/langextract) is particularly promising, see e.g. [Can LangExtract Turn Messy Clinical Notes into Structured Data?](https://towardsdatascience.com/can-langextract-turn-messy-clinical-notes-into-structured-data/5f0f9f8cdcb3) which has a kaggle notebook example.
...
* [Worksheet 8.1 Topic Models and Bayes]({{ site.data.2025.block08.ws01.url }}) 
