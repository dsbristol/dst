...
*  [06.1 Decisions Trees & Random Forests]({{ site.data.2025.block06.s01.url }})
  * [Reference R code]({{ site.data.2025.block06.c01.url }})
...
* [6.3.1 Workshop on Random Forests in R (.Rmd)]({{ site.data.2025.block06.s0201.url }})
* [6.3.1 Workshop on Random Forests in R (.html)]({{ site.data.2025.block06.s0201-h.url }})
* [6.3.2 Workshop on Random Forests in Python]({{ site.data.2025.block06.s0202.url }})

## Assessments:

* [Portfolio 06]({{ site.data.2025.block06.portfolio.url }}) of the full [Portfolio]({{ site.data.2025.individualassessment1.url }}).
...
* [Worksheet 6.1 Trees, Forests, Decisions]({{ site.data.2025.block06.ws01.url }})
