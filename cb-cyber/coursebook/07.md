...
* [Worksheet 7.1 Topic Models and Bayes]({{ site.data.cb-cyber.block07.ws01.url }}) 
...
* [{{ site.data.cb-cyber.vid07.v0301.text }}]({{ site.data.cb-cyber.vid07.v0301.url }})
  * [Python Notebook: 7.3.1 Topic Models (Software and downloading data)]({{ site.data.cb-cyber.block07.s0301.url }})
...
* [Assessment 3]({{ site.data.cb-cyber.assessment3.url }}) will be set in this week; see [Assessments](../assessments.md). This is a summatieve assessment (i.e. does contribute to your grade) and will be due in Week 16.
