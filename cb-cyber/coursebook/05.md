...
* [Worksheet 5.1 Non-parametrics]({{ site.data.cb-cyber.block05.ws01.url }}) 
* [Worksheet 5.2 Outliers and Missing Data]({{ site.data.cb-cyber.block05.ws02.url }})
...
* [Assessment 2]({{ site.data.cb-cyber.assessment2.url }}) will be set in this week; see [Assessments](../assessments.md). This is a summatieve assessment (i.e. does contribute to your grade) and will be due in Week 12.
