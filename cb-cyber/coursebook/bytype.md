...
* [{{ site.data.cyber.vid01.v0101.text }}]({{ site.data.cyber.vid01.v0101.url }})
  * [Slides]({{ site.data.cyber.block01.s0101-Intro.url }})
* [{{ site.data.cyber.vid01.v0102.text }}]({{ site.data.cyber.vid01.v0102.url }})
  * [Slides]({{ site.data.cyber.block01.s0102-EDA.url }})
  * [Reference R code]({{ site.data.cyber.block01.c0101-EDA.url }}) (NB: See 1.3.1 for explanation)
* [{{ site.data.cyber.vid02.v0101.text }}]({{ site.data.cyber.vid02.v0101.url }})
  * [Slides]({{ site.data.cyber.block02.s0101-Regression.url }})
* [{{ site.data.cyber.vid02.v0102.text }}]({{ site.data.cyber.vid02.v0102.url }}) 
  * [Slides]({{ site.data.cyber.block02.s0102-Regression.url }})
  * [Reference R code]({{ site.data.cyber.block02.c01-Regression.url }})
* [{{ site.data.cyber.vid02.v0201.text }}]({{ site.data.cyber.vid02.v0201.url }})
  * [Slides]({{ site.data.cyber.block02.s0201-Testing.url }})
* [{{ site.data.cyber.vid02.v0202.text }}]({{ site.data.cyber.vid02.v0202.url }})
  * [Slides]({{ site.data.cyber.block02.s0202-Testing.url }}) 
* [{{ site.data.cyber.vid02.v0203.text }}]({{ site.data.cyber.vid02.v0203.url }})
  * [Slides]({{ site.data.cyber.block02.s0203-Testing.url }}) 
  * [Reference R code]({{ site.data.cyber.block02.c02-Testing.url }})
...
* [{{ site.data.cyber.vid03.v0202.text }}]({{ site.data.cyber.vid03.v0201.url }})
...
*  06.1 Decision Trees and Random Forests:
  * [{{ site.data.cyber.vid06.v0101.text }}]({{ site.data.cyber.vid06.v0101.url }})
    * [Slides]({{ site.data.cyber.block06.s0101.url }})
  * [{{ site.data.cyber.vid06.v0102.text }}]({{ site.data.cyber.vid06.v0102.url }})
    * [Slides]({{ site.data.cyber.block06.s0102.url }})
  * [Reference R code]({{ site.data.cyber.block06.c01.url }})
...
* 11.1 Parallel data with MapReduce and Spark
  * [{{ site.data.cyber.vid11.v0101.text }}]({{ site.data.cyber.vid11.v0101.url }})
    * [Slides]({{ site.data.cyber.block11.s0101.url }})
  * [{{ site.data.cyber.vid11.v0102.text }}]({{ site.data.cyber.vid11.v0102.url }})
    * [Slides]({{ site.data.cyber.block11.s0102.url }})
* 12.1 Ethics in Data Science
  * [{{ site.data.cyber.vid12.v0101.text }}]({{ site.data.cyber.vid12.v0101.url }})
    * [Slides]({{ site.data.cyber.block12.s0101.url }})
  * [{{ site.data.cyber.vid12.v0102.text }}]({{ site.data.cyber.vid12.v0102.url }})
    * [Slides]({{ site.data.cyber.block12.s0102.url }})
  * [{{ site.data.cyber.vid12.v0103.text }}]({{ site.data.cyber.vid12.v0103.url }})
    * [Slides]({{ site.data.cyber.block12.s0103.url }})

## Worksheets <a name="Worksheets"></a>

* [Worksheet 01.2 Exploratory Data Analysis]({{ site.data.cyber.block01.ws02.url }})
* [Worksheet 02.1 Regression and Correlation]({{ site.data.cyber.block02.ws01.url }})
* [Worksheet 02.2 Statistical Testing]({{ site.data.cyber.block02.ws02.url }})
* [Worksheet 03.1 Latent Spaces and PCA]({{ site.data.cyber.block03.ws01.url }})
* [Worksheet 03.2 Clustering]({{ site.data.cyber.block03.ws02.url }})
* [Worksheet 04.1 Non-parametrics]({{ site.data.cyber.block04.ws01.url }})
* [Worksheet 04.2 Outliers and Missing Data]({{ site.data.cyber.block04.ws02.url }})
* [Worksheet 05.1 Introduction to Classification]({{ site.data.cyber.block05.ws01.url }})
* [Worksheet 05.2 Ensemble Learning]({{ site.data.cyber.block05.ws02.url }})
* [Worksheet 06.1 Trees, Forests, Decisions]({{ site.data.cyber.block06.ws01.url }})
* [Worksheet 07.1 Topic Models]({{ site.data.cyber.block07.ws01.url }})
* [Worksheet 08.1 Algorithms]({{ site.data.cyber.block08.ws01.url }})
* [Worksheet 09.1 Neural Networks]({{ site.data.cyber.block09.ws01.url }})
* [Worksheet 10.1 Parallel algorithms]({{ site.data.cyber.block10.ws01.url }})
* [Worksheet 11.1 Parallel Infrastructure]({{ site.data.cyber.block11.ws01.url }}) 
* [Worksheet 12.1 Ethics and Privacy in Data Science]({{ site.data.cyber.block12.ws01.url }})
...
* [{{ site.data.cyber.vid01.v0301.text }}]({{ site.data.cyber.vid01.v0301.url }})
  * [Rmd for 1.3.1 Introduction to R Studio]({{ site.data.cyber.block01.c0103-EDA.url }}) 
* [{{ site.data.cyber.vid01.v0302.text }}]({{ site.data.cyber.vid01.v0302.url }})
  * [Rmd for 1.3.2 Exploratory Data Analysis R markdown]({{ site.data.cyber.block01.s0103-EDA.url }}) 
* 1.3.3 Workshop Lecture on Assessments, split into the following parts:
  - [{{ site.data.cyber.vid01.v030301.text }}]({{ site.data.cyber.vid01.v030301.url }})
  - [{{ site.data.cyber.vid01.v030302.text }}]({{ site.data.cyber.vid01.v030302.url }})
  - [{{ site.data.cyber.vid01.v030303.text }}]({{ site.data.cyber.vid01.v030303.url }})
  - [{{ site.data.cyber.vid01.v030304.text }}]({{ site.data.cyber.vid01.v030304.url }})
  - [{{ site.data.cyber.vid01.v030305.text }}]({{ site.data.cyber.vid01.v030305.url }})
* [{{ site.data.cyber.vid02.v0301.text }}]({{ site.data.cyber.vid02.v0301.url }})
  * [Rmd for 2.3 Model Selection for Regression R markdown]({{ site.data.cyber.block02.s03-ModelSelection.url }})
...
* [{{ site.data.cyber.vid06.v0201.text }}]({{ site.data.cyber.vid06.v0201.url }})
  * [Rmd for 6.2 Workshop on Random Forests]({{ site.data.cyber.block06.s0201.url }})
* [{{ site.data.cyber.vid06.v0202.text }}]({{ site.data.cyber.vid06.v0202.url }})
  * [Python for 6.2 Workshop on Random Forests]({{ site.data.cyber.block06.s0202.url }})
* [{{ site.data.cyber.vid07.v0301.text }}]({{ site.data.cyber.vid07.v0301.url }})
  * [Rmd for 7.3.1 Topic Models (Software and downloading data)]({{ site.data.cyber.block07.s0301.url }})
...
* 11.2 Workshop Lecture on Coding Parallel Algorithms, split into the following parts:
  * [{{ site.data.cyber.vid11.v0200.text }}]({{ site.data.cyber.vid11.v0200.url }})
  * [{{ site.data.cyber.vid11.v0201.text }}]({{ site.data.cyber.vid11.v0201.url }})
  * [{{ site.data.cyber.vid11.v0202.text }}]({{ site.data.cyber.vid11.v0202.url }})
  * [11.2 Python Notebook: Workshop on Coding Parallel Algorithms]({{ site.data.cyber.block11.s02.url }})
...
- [Assessment 0]({{ site.data.cyber.assessment0.url }}) (Formative, i.e. does not contribute to grade)
- [Assessment 1]({{ site.data.cyber.assessment1.url }})
- [Assessment 2]({{ site.data.cyber.assessment2.url }})

Semester 2:
- [Assessment 3]({{ site.data.cyber.assessment3.url }})
- [Assessment 4]({{ site.data.cyber.assessment4.url }})
- [Assessment 5]({{ site.data.cyber.assessment5.url }})
