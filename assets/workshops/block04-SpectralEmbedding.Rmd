...
This workshop explores spectral clustering on cyber data using DBSCAN. Because of the peculiarities of this data as visualised in [Lecture 4.1](https://dsbristol.github.io/dst/assets/slides/04.1-LatentStructuresPCA.pdf) using Spectral decomposition and clustered in [Lecture 4.2](https://dsbristol.github.io/dst/assets/slides/04.2-Clustering.pdf), it generates strange structure that can only be handled with carefully chosen methods. 
...
- How would you go about making a real classifier from a clustering model, that can be deployed on a training dataset?
  - Could you use the classifier to learn the "correct" number of dimensions? How?
  - Is the dimension of all embedding methods the same?
  - Is dimension as chosen above the only concept of dimension?
  - Back up your exploration with a demonstration.
