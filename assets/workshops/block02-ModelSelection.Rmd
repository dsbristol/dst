...
In this workshop we will explore the use of Cross-Validation to assess model fit and perform model selection, in the context of simple regression models. Importantly, the data we use will have different structural features, which will affect the implications of Cross-Validation. Even when we move to more complex machine learning models, the principles will be the same.

We will consider two datasets that exhibit different structural features and therefore different implications for Cross-Validation. One is a "standard" dataset with many features and independent observations, the other is a time series with strong dependence between observations.
...
#### See **Question Q1** in Block 2 Questions
...
#### See **Question Q2** in Block 2 Questions
...
Q: What is going on here with the results?
Q: What is going on with the column headers? How might we make it prettier without bloating the code?
...
#### See **Question Q3** in Block 2 Questions
...
#### See **Question Q4** in Block 2 Questions
