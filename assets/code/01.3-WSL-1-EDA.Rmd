---
title: "1.2 - Workshop Lecture on EDA"
...
The code that this executes is duplicated below. You can look at this in your browser, and if you choose, download it and the data.

Make sure you take a look and understand how the columns get named.
...
## Random Variables
A continuous RV is defined via a probability density function $f_X$:
$$
\mathrm{Pr}(X = x) =f_X(x)
$$
...
```
Unless there is a trivial amount of data, we always reject the null. No surprise!
